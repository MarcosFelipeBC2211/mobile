...
import {format} from 'react-native';

import {cpfMask, phoneMask, cepMask, dataMask, cnpjMask} from '../../../masks/masks';
...
export default function CadastroMotorista(props){
    ...
    dados.append("celular", motoristaController.cep);
